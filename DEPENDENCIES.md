...
following Free and Open Source software:
    ...
    github.com/containerd/containerd                                             v1.7.23                               Apache License 2.0
    github.com/containerd/errdefs                                                v0.3.0                                Apache License 2.0
    ...
    github.com/cyphar/filepath-securejoin                                        v0.3.4                                3-clause BSD license
    ...
    github.com/prometheus/common                                                 v0.60.0                               Apache License 2.0
    ...
    go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc  v0.56.0                               Apache License 2.0
    go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp                v0.56.0                               Apache License 2.0
    go.opentelemetry.io/otel                                                     v1.31.0                               Apache License 2.0
    go.opentelemetry.io/otel/exporters/otlp/otlptrace                            v1.31.0                               Apache License 2.0
    go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc              v1.31.0                               Apache License 2.0
    go.opentelemetry.io/otel/metric                                              v1.31.0                               Apache License 2.0
    go.opentelemetry.io/otel/sdk                                                 v1.31.0                               Apache License 2.0
    go.opentelemetry.io/otel/trace                                               v1.31.0                               Apache License 2.0
    go.opentelemetry.io/proto/otlp                                               v1.3.1                                Apache License 2.0
    golang.org/x/crypto                                                          v0.28.0                               3-clause BSD license
    golang.org/x/exp                                                             v0.0.0-20241009180824-f66d83c29e7c    3-clause BSD license
    golang.org/x/mod                                                             v0.21.0                               3-clause BSD license
    golang.org/x/net                                                             v0.30.0                               3-clause BSD license
    golang.org/x/oauth2                                                          v0.23.0                               3-clause BSD license
    golang.org/x/sync                                                            v0.8.0                                3-clause BSD license
    golang.org/x/sys                                                             v0.26.0                               3-clause BSD license
    golang.org/x/term                                                            v0.25.0                               3-clause BSD license
    golang.org/x/text                                                            v0.19.0                               3-clause BSD license
    golang.org/x/time                                                            v0.7.0                                3-clause BSD license
    golang.org/x/tools                                                           v0.26.0                               3-clause BSD license
    ...
    google.golang.org/genproto/googleapis/api                                    v0.0.0-20241021214115-324edc3d5d38    Apache License 2.0
    google.golang.org/genproto/googleapis/rpc                                    v0.0.0-20241021214115-324edc3d5d38    Apache License 2.0
    google.golang.org/grpc                                                       v1.67.1                               Apache License 2.0
    google.golang.org/protobuf                                                   v1.35.1                               3-clause BSD license
    ...
    gvisor.dev/gvisor                                                            v0.0.0-20241023063205-85d0c19524ca    Apache License 2.0, MIT license
    helm.sh/helm/v3                                                              v3.16.2                               Apache License 2.0
    k8s.io/api                                                                   v0.31.2                               Apache License 2.0
    k8s.io/apiextensions-apiserver                                               v0.31.2                               Apache License 2.0
    k8s.io/apimachinery                                                          v0.31.2                               3-clause BSD license, Apache License 2.0
    k8s.io/apiserver                                                             v0.31.2                               Apache License 2.0
    k8s.io/cli-runtime                                                           v0.31.2                               Apache License 2.0
    k8s.io/client-go                                                             v0.31.2                               3-clause BSD license, Apache License 2.0
    k8s.io/component-base                                                        v0.31.2                               Apache License 2.0
    k8s.io/klog/v2                                                               v2.130.1                              Apache License 2.0
    k8s.io/kube-openapi                                                          v0.0.0-20241009091222-67ed5848f094    3-clause BSD license, Apache License 2.0
    k8s.io/kubectl                                                               v0.31.2                               Apache License 2.0
    k8s.io/utils                                                                 v0.0.0-20240921022957-49e7df575cb6    3-clause BSD license, Apache License 2.0
